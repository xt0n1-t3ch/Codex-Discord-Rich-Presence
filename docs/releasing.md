...
`scripts/release-contract.json` is the machine-readable owner for the candidate product version, core version, config schema, checksum manifest, and both Windows target/artifact/SBOM/PE-machine contracts. For v1.11.0:

- binary/workspace: 1.11.0;
